...
public class ClientSounds extends Module {
    ...
    private final ModeSetting soundMode = new ModeSetting("Мод звука", "Первый", "Первый", "Второй", "Третий", "Celestial");
    ...
    private static final Identifier ENABLE_ID_CELESTIAL = Identifier.of("mre", "module_enable_celestial");
    private static final Identifier DISABLE_ID_CELESTIAL = Identifier.of("mre", "module_disable_celestial");
    ...
    private static final SoundEvent ENABLE_EVENT_CELESTIAL = SoundEvent.of(ENABLE_ID_CELESTIAL);
    private static final SoundEvent DISABLE_EVENT_CELESTIAL = SoundEvent.of(DISABLE_ID_CELESTIAL);
    ...
    public static void play(boolean enabled) {
        ...
        SoundEvent soundToPlay = switch (INSTANCE.soundMode.getValue()) {
            ...
            case "Celestial" -> enabled ? ENABLE_EVENT_CELESTIAL : DISABLE_EVENT_CELESTIAL;
