...
public class Interface extends Module {
    ...
    private final ModeSetting targetStyle = new ModeSetting("Стиль таргета", "Nursultan", "Nursultan", "Lunex", "Celestial");
    ...
    private void renderWatermarkNursultan(DrawContext context) {
        ...
        DrawUtil.drawText(Fonts.LUNEX.get(), "\ue900", x + 4.2f, y + 3.1f, animatedThemeColor, 15f);
    ...
    private void renderTargetHUDMoonward(DrawContext context) {
        ...
        if (targetTotalHp <= potentialDamage - 1 && targetTotalHp > 0) {
            topText = "WIN";
            topColor = ColorProvider.rgba(0, 255, 0, (int) (255 * animAlpha));
        } else {
            topText = myTotalHp >= targetTotalHp ? "WIN" : "LOSE";
            topColor = myTotalHp >= targetTotalHp ? ColorProvider.rgba(0, 255, 0, (int) (255 * animAlpha)) : ColorProvider.rgba(255, 0, 0, (int) (255 * animAlpha));
        }
